...
const navigationItems: Record<UserRole, NavItem[]> = {
  customer: [
    ...
    { title: "Get a Quote", url: "/quote", icon: Mail },
  ...
  dispatcher: [
    ...
    { title: "Order Queue", url: "/dispatcher/orders", icon: ClipboardList },
    { title: "Map View", url: "/dispatcher/map", icon: Map },
    { title: "Drivers", url: "/dispatcher/drivers", icon: Users },
    { title: "Analytics", url: "/dispatcher/analytics", icon: BarChart3 },
    { title: "Notifications", url: "/dispatcher/notifications", icon: Bell },
    { title: "Settings", url: "/dispatcher/settings", icon: Settings },
  ],
  driver: [
    { title: "Dashboard", url: "/driver/dashboard", icon: Home },
    { title: "Active Jobs", url: "/driver/jobs", icon: Truck },
    { title: "Available Jobs", url: "/driver/available", icon: ClipboardList },
  ...
  admin: [
    ...
    { title: "System", url: "/admin/system", icon: Wrench },
...
export function Sidebar() {
  ...
  return (
    <SidebarUI className="border-r border-border" collapsible="icon">
      <SidebarHeader className="border-b border-border p-4">
        <div className="flex items-center gap-2">
          <div className="w-1 h-8 bg-primary rounded-full" />
          {open && (
            <div>
              <h2 className="font-bold text-foreground">Preferred Solutions</h2>
